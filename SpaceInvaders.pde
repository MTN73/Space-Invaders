...
void instructions() { //instructions screen
...
void spaceship(){ //method for the spaceship
...
void drawInvaders() { //method for drawing the aliens
...
void drawScore() { //method for drawing the score
  ...
  highscore = int(loadStrings(path)); //load the highscore from 'hs.txt'. It's path is already stored in the path variable
...
void checkInvadersHitWall() { //method to check if the aliens have reached either edge of the screen
...
void checkLazerHitAlien(int row, int column) { //method to check if the lazer has hit an alien
...
void exitButton() { //method for the exit button in the top right of some screens
...
void init() { //method that resets variables used in game
...
void drawStars() { //method to draw the stars
...
void game() { //method used to play the game
